"""
Django settings for ph_ch_project project.
...
SECRET_KEY = 'django-insecure-lj!0$kl!88ua+mvm#ivz7_uk#*dma+ce$x=30$8-cw_^9o#$=p'
...
ROOT_URLCONF = 'ph_ch_project.urls'
...
WSGI_APPLICATION = 'ph_ch_project.wsgi.application'
